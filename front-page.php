    ...
    <section class="home__follow">
      ...
      <ul class="home__followList">
        <li class="home__followItem">
          <div class="home__followIcon"><a href=""><?php echo file_get_contents(get_stylesheet_directory_uri() . '/assets/images/icons/icon_fb.svg'); ?></a></div>
        </li>
        <li class="home__followItem">
          <div class="home__followIcon"><a href=""><?php echo file_get_contents(get_stylesheet_directory_uri() . '/assets/images/icons/icon_instagram.svg'); ?></a></div>
        </li>
        <li class="home__followItem">
          <div class="home__followIcon"><a href=""><?php echo file_get_contents(get_stylesheet_directory_uri() . '/assets/images/icons/icon_twitter.svg'); ?></a></div>
        </li>
        <li class="home__followItem">
          <div class="home__followIcon"><a href=""><?php echo file_get_contents(get_stylesheet_directory_uri() . '/assets/images/icons/icon_mail.svg'); ?></a></div>
        </li>
      </ul>
    </section>
  </div>
